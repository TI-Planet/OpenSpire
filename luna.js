function integrateWasmJS(Module) {
 var method = Module["wasmJSMethod"] || Module["wasmJSMethod"] || "native-wasm,asmjs" || "native-wasm";
 Module["wasmJSMethod"] = method;
 var wasmTextFile = Module["wasmTextFile"] || "luna.wast";
 var wasmBinaryFile = Module["wasmBinaryFile"] || "luna.wasm";
 var asmjsCodeFile = Module["asmjsCodeFile"] || "luna.asm.js";
...
Module["preRun"] = (function() {
 ...
 makeAndDownloadTNS = (function(luaScript, filename) {
  ...
  FS.writeFile(filename, luaScript, {
   encoding: "utf8"
  });
  try {
   FS.unlink(tnsName);
  ...
  const file = FS.readFile(tnsName, {
   encoding: "binary"
  });
  if (file) {
...
__ATINIT__.push();
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "luna.js.mem" : null;
